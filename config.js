...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'kord_ai-suNaPdzQxeXsk4Uw',
    ...
    STICKER_PACKNAME: process.env.STICKER_PACKNAME || "ℂ𝕠𝕕𝕖𝕩",
    ...
    OWNER_NAME: process.env.OWNER_NAME || "ℂ𝕠𝕕𝕖𝕩",
    BOT_NAME: process.env.BOT_NAME || "ℂ𝕠𝕕𝕖𝕩",
