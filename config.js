...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'kord_ai-0otjLzOExanJiOO2',
    ...
    STICKER_PACKNAME: process.env.STICKER_PACKNAME || "𐌂Ꝋ𐌃𐌄𐌗",
    ...
    OWNER_NAME: process.env.OWNER_NAME || "₵ØĐɆӾ",
    BOT_NAME: process.env.BOT_NAME || "₵ØĐɆӾ",
